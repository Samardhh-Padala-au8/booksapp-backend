...
const userSchema = new mongoose.Schema({
    ...
    age: Number,
    imagelink: String,
    bio: { type: String, default: 'Bio are always cool!' },
    password: {
        type: String,
        required: true,
      },
...
userSchema.pre('save', function(next) {
  ...
  const user = this
    //this function wil assign a placeholder for the image
    // depending upon male and female.
    if(user.isModified('gender')){
      if (this.gender === 'Male' || this.gender ==="male") {
        this.imagelink = 'https://i.ibb.co/gSbgf9K/male-placeholder.jpg';
      } else {
        this.imagelink = 'https://i.ibb.co/dKx0vDS/woman-placeholder.jpg';
      }
    }
